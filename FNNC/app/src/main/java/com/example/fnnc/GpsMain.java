...
import com.example.fnnc.demgps.GpsService;
import com.example.fnnc.demgps.UtilTool;
...
public class GpsMain extends Activity {
	 ...
	 private final static String TAG=GpsMain.class.getSimpleName();
	@Override
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_gps);
		 editText=(EditText)findViewById(R.id.ShowJWD);
		  ...
		  filter.addAction("mr_immortalz.com.stereoview.demgps.GpsService");
